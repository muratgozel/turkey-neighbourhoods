...
export class Resource {
    ...
    async isExistingDataFresh({endpoint, defaultRequestOptions}: {endpoint: string, defaultRequestOptions: object}): Promise<boolean> {
    ...
    async findMostRecentEtag(): Promise<string> {
        try {
